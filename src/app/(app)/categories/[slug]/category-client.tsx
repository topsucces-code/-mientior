...
export function CategoryPageClient({
  ...
  categoryHeroData,
  seoContent,
  categorySlug: _categorySlug, // Prefixed with _ to mark as intentionally unused
      ...
      if (value) {
        ...
        if (Array.isArray(newFilters[filterType])) {
          ...
          if (filtered.length === 0) {
            ...
            // Type assertion needed for dynamic filter type assignment
            (newFilters as Record<string, string[]>)[filterType as string] = filtered
          }
        }
      } else {
