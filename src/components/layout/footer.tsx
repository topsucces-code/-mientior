...
// Footer links keys for translation
const footerLinkKeys = {
  shop: [
    ...
    { href: '/bestsellers', key: 'bestsellers' },
  ],
  company: [
    ...
    { href: '/become-seller', key: 'becomeSeller' },
  ],
  support: [
    { href: '/contact', key: 'contactUs' },
    { href: '/faq', key: 'faq' },
    { href: '/livraison', key: 'shipping' },
    { href: '/garantie', key: 'returns' },
    { href: '/account/orders', key: 'trackOrder' },
  ],
  legal: [
    { href: '/legal#privacy', key: 'privacy' },
    { href: '/legal#terms', key: 'terms' },
    { href: '/legal#cookies', key: 'cookies' },
    { href: '/legal', key: 'legalInfo' },
  ],
}
...
const trustBadgeKeys = [
  ...
  { icon: CreditCard, key: 'flexiblePayment' },
]
      ...
      <div className="border-b border-white/10">
        <div className="container mx-auto px-3 py-10 md:px-4 md:py-14 lg:px-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
            ...
            {/* Shop Links */}
            <div>
              <h3 className="mb-4 font-semibold text-white">{t('shop')}</h3>
            ...
            {trustBadgeKeys.map((badge) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">{t(`trust.${badge.key}`)}</span>
                </div>
              )
            })}
          </div>
      ...
      <div className="bg-white/5">
        <div className="container mx-auto px-4 py-6 md:px-6 lg:px-8">
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-4 border-t border-white/10 pt-4 text-xs text-blue-200 md:justify-start">
            {footerLinkKeys.legal.map((link, index) => (
              <React.Fragment key={link.href}>
                <Link href={link.href} className="transition-colors hover:text-white hover:underline">
                  {t(`links.${link.key}`)}
                </Link>
                {index < footerLinkKeys.legal.length - 1 && <span className="text-white/30">•</span>}
              </React.Fragment>
            ))}
          </div>
        </div>
