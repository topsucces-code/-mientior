    ...
    <div className="sticky top-[120px] z-10 bg-white/95 backdrop-blur-md border-b border-platinum-300 p-4">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="text-base font-semibold text-anthracite-700">
          {totalCount.toLocaleString('fr-FR')} produits trouvés
        </div>
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-nuanced-600 hidden sm:inline">Trier par:</span>
          ...
          {onItemsPerPageChange && (
            <div className="hidden md:flex items-center gap-2">
              <span className="text-sm text-nuanced-600">Afficher:</span>
